...
<br />&nbsp;&nbsp;&nbsp;<a href="./index.php?module=config-plugins&amp;ougc_awards_import=nickawards">Import From Nickman\'s Awards System</a>',
    ...
    'setting_ougc_awards_perPage_desc' => 'Maximum number of items to show per page or within listings.',
    'setting_ougc_awards_perPageViewUsers' => 'Awards Per Page in View Modal',
    'setting_ougc_awards_perPageViewUsers_desc' => 'Maximum number of awards to show per page in the view modal.',
