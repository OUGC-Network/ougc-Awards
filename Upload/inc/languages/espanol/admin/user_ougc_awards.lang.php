...
<br />&nbsp;&nbsp;&nbsp;<a href="./index.php?module=config-plugins&amp;ougc_awards_import=nickawards">Importar Desde el Sistema de Premios de Nickman</a>',
    ...
    'setting_ougc_awards_perPage_desc' => 'Número máximo de elementos a mostrar por página en las paginas Ver Dueños de Categorias, Ver Dueños de Premios, Ver Solicitudes, and Registros de Tareas.',
    'setting_ougc_awards_perPageMyAwards' => 'Otorgamientos Por Página en Mis Premios',
    'setting_ougc_awards_perPageMyAwards_desc' => 'Número máximo de otorgamientos a mostrar por página en la pagina de Mis Premios.',
    'setting_ougc_awards_perPageViewUsers' => 'Usuarios Por Página en Usuarios Otorgados',
    'setting_ougc_awards_perPageViewUsers_desc' => 'Número máximo de otorgamientos a mostrar por página en la pagina de Usuarios Otorgados.',
    'setting_ougc_awards_perPageViewUserModal' => 'Otorgamientos Por Página en el Modal de Usuario',
    'setting_ougc_awards_perPageViewUserModal_desc' => 'Número máximo de otorgamientos a mostrar por página en el modal de usuario.',
